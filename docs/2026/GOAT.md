...
- Have experience performing simple and complex queries using [GoaT Web](https://goat.genomehubs.org/) Interface to retrieve list of taxa and/or assemblies
- Understand the different indexes on GoaT (taxon and assembly) and how to query associated metadata
- Have experience viewing sequencing status and target lists for projects in the [Earth Biogenome Project](https://www.earthbiogenome.org/) Network.
